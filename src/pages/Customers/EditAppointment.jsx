            ...
            <div className="panel">
                <div className="row" style={{ alignItems: 'center' }}>
                    <div className="col-3 col-sm-12 labeled__button">
                        <SelectionSearch link="sales/allCustomersList" label="العميل" type="outlined" onSelect={(e) => setState({...state, customer: parseInt(e)})} placeholder={state.customer_name} />
                    ...
                    <div className="col-6 col-sm-12">
                        <SelectionSearch placeholder="اختر اجراء" link="appointments/getCreateActions" label="الاجراء" modalHead="اضف اجراء جديد" type="outlined" onSelect={(e) => setState({...state, action: parseInt(e)})} create setState={setState} state={state} placeholder={state.action_name} />
