...
const CreatePayment = () => {
    ...
    useEffect(() => {
        ...
        setUser({
            id: token.id,
            name: token.first_name + ' ' + (token.last_name ? token.last_name : ''),
        })
        setState({
            ...
            <div className="row">
                <div className="col-6 col-sm-12">
                    <div className="labeled__button">
                        ...
                        <select className="inputText w-100" onChange={(e) => setState({...state, method: e.target.value})}>
                ...
                <div className="col-6 col-sm-12">
                    ...
                    <input type="text" className="inputText w-100 mt-10" onChange={(e) => setState({...state, Amount: e.target.value})} />
                    {
                ...
                <div className="col-6 col-sm-12">
                    ...
                    <input type="date" readOnly className="inputText w-100 mt-10" value={today} />
                </div>
                <div className="col-6 col-sm-12">
                    <div className="labeled__button">
                        <label className="label mb-10">حالة الدفع</label>
                        <select className="inputText w-100" onChange={(e) => setState({...state, status: e.target.value})}>
                ...
                <div className="col-6 col-sm-12 mt-10">
                    <SelectionSearch link="users/Employees" onSelect={(id) => setState({...state, Collected_by: parseInt(id)})} type="outlined" placeholder={user.name} label="تم التحصيل بواسطة" />
                </div>
                <div className="col-6 col-sm-12">
                    <label className="label mb-10">الرقم المعرف</label>
                    <input type="number" className="inputText w-100 mt-10 mb-10" onChange={(e) => setState({...state, ref_no: e.target.value})} />
                </div>
                <div className="col-6 col-sm-12">
                    <div className="labeled__button">
                    <label className="label mb-10 mt-10">بيانات الدفع</label>
                    <textarea className="inputText" rows="10" onChange={(e) => setState({...state, payment_details: e.target.value})} style={{ width: '100%', height: 100 }} />
                    </div>
                </div>
                <div className="col-6 col-sm-12">
                    <div className="labeled__button">
                        <label className="label mb-10">ملاحظات ايصال الاستلام</label>
                        <textarea className="inputText" rows="10" onChange={(e) => setState({...state, notes: e.target.value})} style={{ width: '100%', height: 100 }} />
                    </div>
                </div>
                <div className="col-6 col-sm-12">
